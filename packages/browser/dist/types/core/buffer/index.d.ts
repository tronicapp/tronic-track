...
export declare class ReceiverBuffered implements PromiseLike<[Receiver, Context]>, ReceiverBrowserCore {
    ...
    identify: (channelId: string, id?: object | import("../user").ID, traits?: import("@tronic/receiver-core").UserTraits | import("@tronic/receiver-core").Callback | null | undefined, options?: import("@tronic/receiver-core").Callback | import("../events").Options | undefined, callback?: import("@tronic/receiver-core").Callback | undefined) => Promise<Context>;
    reset: () => Promise<void>;
    track: (eventOrEventName: string | import("../events").TronicEvent, channelId?: string | undefined, properties?: import("@tronic/receiver-core").Callback | import("../events").EventProperties | undefined, options?: import("@tronic/receiver-core").Callback | import("../events").Options | undefined, callback?: import("@tronic/receiver-core").Callback | undefined) => Promise<Context>;
