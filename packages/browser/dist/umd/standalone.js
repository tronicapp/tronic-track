...
function resolveArguments(channelId, userId, eventName, properties, options, callback) {
    ...
    if (!channelId || !(0,helpers/* isString */.HD)(channelId)) {
        throw new Error('ChannelId missing');
    }
    if (!userId || !(0,helpers/* isString */.HD)(userId)) {
        throw new Error('UserId missing');
    }
    var name = (0,helpers/* isPlainObject */.PO)(eventName) ? eventName.event : eventName;
    if (!name || !(0,helpers/* isString */.HD)(name)) {
        throw new Error('Event missing');
    }
    var data = (0,helpers/* isPlainObject */.PO)(eventName)
    ...
    if ((0,helpers/* isPlainObject */.PO)(eventName) && !(0,helpers/* isFunction */.mf)(properties)) {
...
var TRONIC_API_HOST = 'localhost:3000';
...
//# sourceMappingURL=index.js.map
// EXTERNAL MODULE: ../../node_modules/dset/dist/index.mjs
var dist = __webpack_require__(380);
...
var EventFactory = /** @class */ (function () {
    ...
    EventFactory.prototype.context = function (event) {
        ...
        providedOptionsKeys.forEach(function (key) {
            ...
            if (optionsKeys.includes(key)) {
                (0,dist/* dset */.N)(overrides, key, options[key]);
            }
            else {
                (0,dist/* dset */.N)(context, key, options[key]);
            }
        });
    ...
    EventFactory.prototype.normalize = function (event, pageCtx) {
        ...
        var newEvent = events_assign(events_assign(events_assign({ timestamp: new Date() }, rest), { context: context }), overrides);
...
// EXTERNAL MODULE: ../../node_modules/@lukeed/uuid/dist/index.mjs
var uuid_dist = __webpack_require__(831);
...
var User = /** @class */ (function () {
    function User(options, cookieOptions) {
        ...
        this.anonymousId = function (id) {
            ...
            _this.identityStore.set(_this.anonKey, id !== null && id !== void 0 ? id : (0,uuid_dist.v4)());
            return _this.identityStore.getAndSync(_this.anonKey);
        };
...
var standalone_receiver_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
function getWriteKey() {
    ...
    var regex = /http.*\/receiver\.js\/v1\/([^/]*)(\/platform)?\/receiver.*/;
    var scripts = Array.prototype.slice.call(document.querySelectorAll('script'));
...
function install() {
    var _a, _b;
    return standalone_receiver_awaiter(this, void 0, Promise, function () {
        var writeKey, options, _c;
        return standalone_receiver_generator(this, function (_d) {
            switch (_d.label) {
                case 0:
...
;// CONCATENATED MODULE: ./src/lib/browser-polyfill.ts
...
;// CONCATENATED MODULE: ./src/lib/csp-detection.ts
var csp_detection_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var csp_detection_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var isReceiverCSPError = function (e) {
    return e.disposition !== 'report' && e.blockedURI.includes('cdn.tronic');
};
function loadAjsClassicFallback() {
    return csp_detection_awaiter(this, void 0, Promise, function () {
        var classicPath;
        return csp_detection_generator(this, function (_a) {
            switch (_a.label) {
                case 0:
...
var standalone_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var standalone_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
var standalone_spreadArray = (undefined && undefined.__spreadArray) || function (to, from, pack) {
    if (pack || arguments.length === 2) for (var i = 0, l = from.length, ar; i < l; i++) {
        if (ar || !(i in from)) {
            if (!ar) ar = Array.prototype.slice.call(from, 0, i);
            ar[i] = from[i];
...
function onError(err) {
    ...
    sendErrorMetrics(standalone_spreadArray([
        'type:initialization'
 ...
 **/
function standalone_attempt(promise) {
    return standalone_awaiter(this, void 0, void 0, function () {
        var result, err_1;
        return standalone_generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
...
window.TronicReceiver = __webpack_exports__;
/******/ })()
;
