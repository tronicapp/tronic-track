...
export function link(links, event, properties, options) {
    ...
    elements.forEach(function (el) {
        el.addEventListener('click', function (elementEvent) {
            ...
            var trackEvent = pTimeout(_this.track(channelId, userId, ev, props, options !== null && options !== void 0 ? options : {}), (_b = _this.settings.timeout) !== null && _b !== void 0 ? _b : 500);
...
export function form(forms, event, properties, options) {
    ...
    elements.forEach(function (el) {
        ...
        var handler = function (elementEvent) {
            ...
            var ev = event instanceof Function ? event(el) : event;
            var props = properties instanceof Function ? properties(el) : properties;
            var trackEvent = pTimeout(_this.track(channelId, userId, ev, props, options !== null && options !== void 0 ? options : {}), (_a = _this.settings.timeout) !== null && _a !== void 0 ? _a : 500);
            trackEvent
                .catch(console.error)
                .then(function () {
                el.submit();
