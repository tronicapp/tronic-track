...
exports.ReceiverBuffered = exports.callReceiverMethod = exports.PreInitMethodCallBuffer = exports.PreInitMethodCall = exports.hasBufferedPageContextAsLastArg = exports.popPageContext = exports.flushReceiverCallsInNewTask = exports.flushOn = exports.flushAddSourceMiddleware = void 0;
...
var flushAddSourceMiddleware = function (receiver, buffer) { return __awaiter(void 0, void 0, void 0, function () {
    var _i, _a, c;
...
exports.flushOn = flushSyncReceiverCalls.bind(this, 'on');
/*
...
exports.flushReceiverCallsInNewTask = flushReceiverCallsInNewTask;
...
var PreInitMethodCallBuffer = /** @class */ (function () {
    ...
    PreInitMethodCallBuffer.prototype.push = function () {
        ...
        calls.forEach(function (call) {
            ...
            if (eventsExpectingPageContext.includes(call.method) &&
                ...
                call.args = __spreadArray(__spreadArray([], call.args, true), [(0, page_1.getDefaultBufferedPageContext)()], false);
            }
    ...
    PreInitMethodCallBuffer.prototype._pushSnippetWindowBuffer = function () {
        var wa = (0, global_receiver_helper_1.getGlobalReceiver)();
        if (!Array.isArray(wa))
            return undefined;
...
exports.callReceiverMethod = callReceiverMethod;
...
exports.ReceiverBuffered = ReceiverBuffered;
