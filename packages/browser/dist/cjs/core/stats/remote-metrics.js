...
var createRemoteMetric = function (metric, tags, versionType) {
    ...
    return {
        ...
        metric: metric,
        value: 1,
        tags: __assign(__assign({}, formattedTags), { library: 'receiver.js', library_version: versionType === 'web' ? "next-".concat(version_1.version) : "npm:next-".concat(version_1.version) }),
    };
};
...
var RemoteMetrics = /** @class */ (function () {
    function RemoteMetrics(options) {
        var _this = this;
        var _a, _b, _c, _d;
        this.host = (_a = options === null || options === void 0 ? void 0 : options.host) !== null && _a !== void 0 ? _a : constants_1.TRONIC_API_HOST;
    ...
    RemoteMetrics.prototype.increment = function (metric, tags) {
        ...
        var remoteMetric = createRemoteMetric(metric, tags, (0, version_type_1.getVersionType)());
