...
var receiver_node_1 = require("../plugins/receiver-node");
...
var ReceiverNode = /** @class */ (function () {
    ...
    ReceiverNode.load = function (settings) {
        return __awaiter(this, void 0, void 0, function () {
            var cookieOptions, queue, options, receiver, nodeSettings, ctx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        receiver = new receiver_1.Receiver(settings, options, queue);
                        nodeSettings = {
                        ...
                        return [4 /*yield*/, receiver.register(validation_1.validation, (0, receiver_node_1.receiverNode)(nodeSettings))];
                    case 1:
                        ctx = _a.sent();
                        receiver.emit('initialize', settings, cookieOptions !== null && cookieOptions !== void 0 ? cookieOptions : {});
