...
exports.receiverNode = exports.post = void 0;
...
function post(event, writeKey) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, node_fetch_1.default)("https://api.tronic.com/v1/".concat(event.type), {
                        method: 'POST',
                        headers: {
...
exports.post = post;
function receiverNode(settings) {
    var _this = this;
